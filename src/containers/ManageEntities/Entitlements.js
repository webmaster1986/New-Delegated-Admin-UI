...
class Entitlements extends Component {
    ...
    getAllApplications = async () => {
        ...
        if(!data || data.error) {
            ...
            this.setState({
                entitiesList: data && data.entitlements || [],
                isLoading: false
            })
        }
    }
                    ...
                    <CardHeader>
                        <Row className="align-items-center">
                            <Col md={6} sm={12} xs={12} className="d-flex">
                                ...
                                <h4 className="mt-10">Entitlement</h4>
                            </Col>
                        </Row>
                    </CardHeader>
                    <CardBody>
                                                ...
                                                <Col>
                                                    <Table className="mr-10"
                                                           ...
                                                           onRow={
                                                               (record, index) => {
                                                                   return {
                                                                       className: expendedRows.includes(record.entitlement) ? 'expanded-tr' : ''
                                                                   };
                                                               }
                                                           }
                                                    />

...
class Role extends Component {
    ...
    render() {
        const { entitiesList, expendedRows, isLoading, selectedRecord } = this.state
        return (
                                                ...
                                                <Col>
                                                    <Table
                                                                                        ...
                                                                                        <Select
                                                                                            ...
                                                                                            })}>
                                                                                            {
                                                                                                ['Low', 'Medium', 'High'].map((x, i) => {
                                                                                                    return(
                                                                                                        <Select.Option value={x.toLowerCase()} key={i}>{x}</Select.Option>
                                                                                                    )
                                                                                                })
                                                                                            }
                                                                    ...
                                                                    <Row className="mt-10">
                                                                        <Col md={12} sm={12} xs={12}>
                                                                            <div className="pull-right">
                                                                                <Button type="primary" className="mr-10" onClick={this.onSave}>{isLoading ?
                                                        ...
                                                        onRow={
                                                            (record, index) => {
                                                                return {
                                                                    className: expendedRows.includes(record.roleName) ? 'expanded-tr' : ''
                                                                };
                                                            }
                                                        }
                                                    />

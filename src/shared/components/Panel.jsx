...
import MinusIcon from 'mdi-react/ArrowDropDownIcon';
      ...
      return (
        <Col md={md} lg={lg} xl={xl} sm={sm} xs={xs}>
          <Card
            ...
            ${divider ? ' panel--divider' : ''}${collapse ? 'panel' : 'panel'} ${panelClass}`}
          >
            <CardBody className="panel__body p-3">
              {refresh ? <div className="panel__refresh"><LoadingIcon /></div> : ''}
              <div className="panel__btns">
                <button className="panel__btn" type="button" onClick={this.onCollapse}><MinusIcon style={{fontSize: 14}}/></button>
